            ...
            <form onSubmit={handlePlaceOrder} className='flex items-center justify-between'>
                ...
                <div>
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                        ...
                        <input name="postcode" type="text" placeholder="Your postcode" className="input input-ghost w-full  input-bordered" />
                    </div>

                    <textarea name="address" className="textarea textarea-bordered h-24 w-full my-5" placeholder="Your address" required></textarea>
